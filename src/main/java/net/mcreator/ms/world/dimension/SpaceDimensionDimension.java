...
public class SpaceDimensionDimension extends MsModElements.ModElement {
	public SpaceDimensionDimension(MsModElements instance) {
		super(instance, 14);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(SpaceBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("ms:space_biome")).getGenerationSettings().getSurfaceBuilder()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("ms:space_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
