...
package net.mcreator.ms.world.dimension;
...
public class LavalanddimensionDimension extends MsModElements.ModElement {
	public LavalanddimensionDimension(MsModElements instance) {
		super(instance, 31);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(AshblockBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("ms:lavaland")).getGenerationSettings().getSurfaceBuilder().get()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("ms:lavalanddimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
