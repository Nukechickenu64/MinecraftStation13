...
public class AshfloorBlock extends MsModElements.ModElement {
	@ObjectHolder("ms:ashfloor")
	public static final Block block = null;

	public AshfloorBlock(MsModElements instance) {
		super(instance, 29);
	}
