...
public class SteelfloorBlock extends MsModElements.ModElement {
	@ObjectHolder("ms:steelfloor")
	public static final Block block = null;

	public SteelfloorBlock(MsModElements instance) {
		super(instance, 27);
	}
